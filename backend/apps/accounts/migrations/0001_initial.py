    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('role', models.CharField(choices=[('student', 'Student'), ('teacher', 'Teacher'), ('mentor', 'Mentor'), ('admin', 'Administrator'), ('super_admin', 'Super-admin')], default='student', max_length=20)),
                ('status', models.CharField(choices=[('active', 'Active'), ('blocked', 'Blocked'), ('pending_deletion', 'Pending deletion'), ('deleted', 'Deleted')], default='active', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purpose', models.CharField(choices=[('register', 'Register'), ('login', 'Login'), ('reset_password', 'Reset password')], default='register', max_length=20)),
